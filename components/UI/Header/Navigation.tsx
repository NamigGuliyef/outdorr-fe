  ...
  return (
    <div className={`font-helvetica ml-auto`}>
      <div
        ...
        <div
          className={`z-[5] transition-all duration-300 lg:duration-500 pb-5 lg:pb-0 linear lg:bg-[#1d1d1d] lg:w-1/4 lg:h-full lg:pt-[5%] lg:pl-[2%] lg:pr-[5%] lg:fixed -right-full ${
            isOpen && "!right-0"
          } top-0`}>
