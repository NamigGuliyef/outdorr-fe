"use client";
import { IProduct, IProducts, ISubProduct } from "@/types/types";
...
export default function ProductsSlider({ products }: { products: ISubProduct[] }) {
    ...
    <div className="font-sf font-semibold">
      <div className="flex flex-col gap-10">
        <div className="flex text-darkgray justify-between items-center">
          <h1 className="text-3.2xl md:text-5xl">Pergolas</h1>
